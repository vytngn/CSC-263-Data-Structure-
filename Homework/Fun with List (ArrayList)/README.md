Write a complete Java program, with a class called FunWithLists, which prompts the user to create a list of the following types:  String, Integer and Double.  
